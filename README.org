...
- [[#roadmap][Roadmap]]
  - [[#detect-the-elisa-plate][Detect the ELISA Plate]]
    - [[#the-starter-code-should-be-able-to-identify-rectangles-as-a-nice-example][the starter code should be able to identify rectangles as a nice example]]
...
- [[#configuration][Configuration]]
  ...
  - [[#opencv-configuration][OpenCV Configuration]]
    - [[#update-documentation-of-the-java-files-in-the-project][update documentation of the java files in the project]]
    - [[#patch-up-the-java-files-in-the-project-that-have-been-copied][patch up the java files in the project that have been copied]]
...
NOTE: current demo application present is essentially reproduced from [[https://brainhub.eu/blog/opencv-react-native-image-processing/]]
** Module Flags
...
*** TODO the starter code should be able to identify rectangles as a nice example
** Read Vials
...
plate to be able to obtain an accurate reading of the color values. This doesn't
sound fun or important, but normalizing an image with respect to deviations in
color as well as lens focal length is an interesting, nuanced problem.
** Feedback
...
There are two aspects to this portion - providing the user with a service to
save and back up the data with a back-end data representation and providing them
...
vials. I (the project lead) plan to play the most significant part in this portion of the
...
*** TODO patch up the java files in the project that have been copied
